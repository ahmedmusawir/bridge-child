...
<section id="TOP-RED-BAR">
	<article class="bar-content">

	<h3>
		<?php the_field('top_bar_text', 'option'); ?>
		<a class="top-bar-btn" href="<?php the_field('top_bar_button_url', 'option'); ?>" title=""><?php the_field('top_bar_button_text', 'option'); ?></a>
	</h3>		
...
<script>
  ...
  fbq('init', '162068211066342');
  fbq('track', 'PageView');
</script>
<noscript><img height="1" width="1" style="display:none"
  src="https://www.facebook.com/tr?id=162068211066342&ev=PageView&noscript=1"
/></noscript>
<!-- End Facebook Pixel Code -->

<!-- BEGIN ROBLY WIDGET CODE -->
<script type='text/javascript'>
  var _d_site = _d_site || '852123e5031b1981a19420a655686cad';
  (function(w, d, p, s, s2) {
    w[p] = w[p] || function() { (w[p].q = w[p].q || []).push(arguments) };
    s = d.createElement('script'); s.async = 1; s.src = '//s3.amazonaws.com/roblyimages/accounts/14299/forms/29512/signup_popup.js';
    s2 = d.getElementsByTagName('script')[0]; s2.parentNode.insertBefore(s, s2);
  })(window, document, 'Robly');
</script>
<!-- END ROBLY WIDGET CODE -->
              
	<!-- Hotjar Tracking Code for www.1800granola.com -->
<script>
    (function(h,o,t,j,a,r){
        h.hj=h.hj||function(){(h.hj.q=h.hj.q||[]).push(arguments)};
        h._hjSettings={hjid:752538,hjsv:6};
